...
{
    public class MongoRepositoryWithTypedId<T, TId> : MongoBase where T : EntityWithTypedId<TId>
    {
        /// <summary>
    ...
    public class MongoRepository<T> : MongoRepositoryWithTypedId<T, ObjectId> where T : Entity
    {
